...
export function CadastroJornal() {
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border-2 border-[#2E5B37] rounded-xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[#2E5B37] text-2xl font-bold">Cadastrar Jornal</h1>
          <p className="text-gray-500 text-sm mt-1">Adicione um novo jornal ao acervo</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" required {...f("titulo")} className={cls} placeholder="Nome do jornal" />
            </div>
            <div>
              <label className="block mb-1.5 text-[#2E5B37] font-medium text-sm">Número da Edição</label>
              <input type="text" {...f("numeroEdicao")} className={cls} placeholder="Ex: Nº 145" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="text" {...f("localizacaoFisica")} className={cls} placeholder="Ex: Estante A, Prateleira 3" />
            </div>
            <div>
              <label className="block mb-1.5 text-[#2E5B37] font-medium text-sm">Periodicidade</label>
              <input type="text" {...f("periodicidade")} className={cls} placeholder="Diário, Semanal, Mensal..." />
            </div>
            <div>
              <label className="block mb-1.5 text-[#2E5B37] font-medium text-sm">Categoria</label>
              <input type="text" {...f("categoria")} className={cls} placeholder="Ex: História, Política" />
            </div>
            <div>
