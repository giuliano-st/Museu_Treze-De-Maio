...
export function CadastroJornal() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Jornal cadastrado:", formData);
    navigate("/cadastro");
  };
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border-2 border-[#2E5B37] rounded-lg shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[#2E5B37]">Cadastrar Jornal</h1>
          <p className="text-gray-600 mt-2">Adicione um novo jornal ao acervo do museu</p>
        </div>
