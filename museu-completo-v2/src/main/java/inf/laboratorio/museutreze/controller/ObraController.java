...
public class ObraController {
    ...
    @PostMapping("/lista")
    public ResponseEntity<List<ObraDTOResponse>> salvarLista(@RequestBody List<ObraDTORequest> obrasDTO) {
        return ResponseEntity.ok(obraService.salvarLista(obrasDTO));
    }
