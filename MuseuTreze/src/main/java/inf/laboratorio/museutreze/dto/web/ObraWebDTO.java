...
public class ObraWebDTO {
    ...
    public String getObra_tipo() {
        return obra_tipo;
    }

    public void setObra_tipo(String obra_tipo) {
    ...
    public List<Long> getAssuntosIds() {
        return assuntosIds;
    }

    public void setAssuntosIds(List<Long> assuntosIds) {
        this.assuntosIds = assuntosIds;
    }

    public Long getId() { return null; }
    public AutorDTOResponse getAutor() { return null; }
    public EditoraDTOResponse getEditora() { return null; }
    public List<AssuntoDTOResponse> getAssuntos() { return null; }
